...
CleanroomBridging is **Swift 2.0**-compliant and requires **Xcode 7 beta 2 or higher** to be built.
...
Once a device-based run destination has been selected, select the appropriate build scheme for the target platform: “CleanroomBridging iOS” or “CleanroomBridging OSX”.
